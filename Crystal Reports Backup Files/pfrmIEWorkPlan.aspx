<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pfrmIEWorkPlan.aspx.cs" Inherits="RBS.Reports.pfrmIEWorkPlan" %>
<%@ Register TagPrefix="uc1" TagName="WebUserControl1" Src="../WebUserControl1.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>pfrmIEWorkPlan</title>
						...
						<TD style="HEIGHT: 25px" align="center" colSpan="2">
							<P>
								<asp:label id="Label1" runat="server" Width="80%" BackColor="White" ForeColor="DarkBlue" Font-Bold="True"
									Font-Names="Verdana" Font-Size="10pt">IE DAILY WORK PLAN REPORT</asp:label></P>
						</TD>
					</TR>
					<TR>
						<TD>
							<TABLE id="Table2" borderColor="#b0c4de" cellSpacing="0" cellPadding="0" width="70%" align="center"
								...
								<% if (Request.Params ["ACTION"]=="U" || Request.Params ["ACTION"]=="E") {%>
								<TR>
									...
									<TD style="WIDTH: 10%; HEIGHT: 31px" align="center">
										<asp:radiobutton id="rdbCOWise" tabIndex="2" runat="server" Text="Controlling Manager Wise" ForeColor="DarkBlue"
											Font-Bold="True" Font-Names="Verdana" Font-Size="10pt" GroupName="g2" AutoPostBack="True"></asp:radiobutton></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 13.17%; HEIGHT: 31px" align="center"><FONT face="Verdana" color="darkblue" size="2"></FONT></TD>
									<TD style="WIDTH: 10%; HEIGHT: 31px" align="center">
								...
								<TR bgColor="#f0f8ff">
									...
									<TD style="HEIGHT: 33px">
										...
										<asp:dropdownlist id="lstCO" tabIndex="6" runat="server" Height="25px" Width="60%" ForeColor="DarkBlue"
									...
									<TD style="WIDTH: 30%">
										<P>
											...
											<asp:textbox id="toDt" onblur="check_date(toDt);compareDates(frmDt,toDt,'From Date Cannot Be Greater Then To Date');"
												...
												Font-Names="Verdana" Font-Size="8pt" MaxLength="15"></asp:textbox></P>
									</TD>
								</TR>
								...
								<TR>
									...
									<TD style="WIDTH: 30%">
										<asp:radiobutton id="rdbIESort" tabIndex="3" runat="server" Text="IE" ForeColor="DarkBlue" Font-Bold="True"
											Font-Names="Verdana" Font-Size="10pt" GroupName="g3" AutoPostBack="True" Checked="True"></asp:radiobutton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

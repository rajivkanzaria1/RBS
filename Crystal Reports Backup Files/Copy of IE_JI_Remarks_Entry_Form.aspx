<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IE_JI_Remarks_Entry_Form.aspx.cs" Inherits="RBS.IE_JI_Remarks_Entry_Form.Copy_of_IE_JI_Remarks_Entry_Form" %>
			...
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px; HEIGHT: 123px"
				...
				<tr>
					<td align="center"><asp:label id="Label1" runat="server" Font-Bold="True" ForeColor="DarkBlue" Font-Size="10pt"
							Font-Names="Verdana" BackColor="White" Width="306px">JI ENGINEER REMARKS ENTRY FORM</asp:label></td>
				</tr>
				<TR>
					<TD align="center">
						<TABLE id="Table4" borderColor="#b0c4de" cellSpacing="0" cellPadding="1" width="97%" bgColor="#f0f8ff"
							...
							<TR>
								<TD style="FONT-WEIGHT: bold; FONT-SIZE: 8pt; WIDTH: 22.38%; COLOR: darkblue; FONT-FAMILY: Verdana; HEIGHT: 15px">Rej 
									Memo No. &amp; Dt.</TD>
								<TD style="WIDTH: 70%; HEIGHT: 15px">
							...
							<TR>
								<TD style="FONT-WEIGHT: bold; FONT-SIZE: 8pt; WIDTH: 22.38%; COLOR: darkblue; FONT-FAMILY: Verdana">IE 
									JI Remarks</TD>
								<TD style="WIDTH: 70%">
									<asp:label id="lblIEJIRemarks" runat="server" Width="90%" Font-Names="Verdana" Font-Size="8pt"
										ForeColor="OrangeRed" Font-Bold="True"></asp:label></TD>
							</TR>
							<TR>
								<TD style="FONT-WEIGHT: bold; FONT-SIZE: 8pt; WIDTH: 22.38%; COLOR: darkblue; FONT-FAMILY: Verdana; HEIGHT: 12px">
									<asp:label id="Label32" runat="server" Width="100%" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue"
										Font-Bold="True">JI Engineer Remarks<Font Color="red">(Max 500 Chars)</Font></asp:label></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 70%">
									...
									<asp:button id="btnCancel" tabIndex="7" runat="server" Width="67px" Font-Names="Verdana" Font-Size="8pt"
										ForeColor="DarkBlue" Font-Bold="True" Text="Cancel"></asp:button></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>

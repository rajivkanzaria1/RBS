<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Central_QOI_Form.aspx.cs" Inherits="RBS.Central_QOI_Form.Central_QOI_Form" %>
					...
					<TR>
						<TD align="center" colspan="5">
							<P><asp:label id="Label1" runat="server" Font-Bold="True" Width="274px" BackColor="White" ForeColor="DarkBlue"
									Font-Size="10pt" Font-Names="Verdana">Quality Of Inspection(Central)</asp:label></P>
						</TD>
					</TR>
					...
					<TR>
						...
						<TD style="WIDTH: 60%; HEIGHT: 61px" colspan="4">
							<asp:dropdownlist id="lstclient" runat="server" Font-Names="Verdana" ForeColor="DarkBlue" Width="50%" AutoPostBack="True">
								...
								<asp:ListItem Value="3">JINDAL RAILWAY</asp:ListItem>
								<asp:ListItem Value="4">JINDAL NON RAILWAY</asp:ListItem>
								<asp:ListItem Value="5">PLATE(BSP)</asp:ListItem>
							</asp:dropdownlist></TD>
					</TR>
					<TR>
						<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="right"><B><FONT face="Verdana" color="darkblue" size="2">Tax Amount
									No. Of IC Issued(Nos.) --&gt;<font color="red" size="1">*</font></FONT></B></TD>
						<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="left" colspan="4"><B><FONT face="Verdana" color="darkblue" size="2">
									<asp:TextBox ID="Textic" Runat="server" MaxLength="13" onkeyup="integersOnly(this)"></asp:TextBox><font color="red" size="1">(Only Numeric Value Allowed)</font></FONT></B></TD>
					</TR>
					<TR>
						<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="right"><B><FONT face="Verdana" color="darkblue" size="2">Tax Amount
									Total Quantity Dispatched in tonnes(IC Issued Quantity in MT)  --&gt;<font color="red" size="1">*</font></FONT></B></TD>
						<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="left" colspan="4"><B><FONT face="Verdana" color="darkblue" size="2">
									<asp:TextBox ID="Textdispatched" Runat="server" MaxLength="13" onkeyup="integersOnly(this)"></asp:TextBox><font color="red" size="1">(Only Numeric Value Allowed)</font></FONT></B></TD>
					</TR>
					<TR>

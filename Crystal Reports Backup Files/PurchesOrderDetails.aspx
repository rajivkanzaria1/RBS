<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchesOrderDetails.aspx.cs" Inherits="RBS.PurchesOrderDetails.PurchesOrderDetails" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 100%; POSITION: absolute; TOP: 8px; HEIGHT: 123px"
						...
						<P>
							<TABLE id="Table2" style="WIDTH: 100%; HEIGHT: 276px" borderColor="#b0c4de" cellSpacing="1"
								...
								<TR>
									...
									<TD style="HEIGHT: 30%"><asp:dropdownlist id="lstItemDesc" tabIndex="2" runat="server" Font-Names="Verdana" Font-Size="7pt"
											ForeColor="DarkBlue" Width="100%" Height="25px" AutoPostBack="True" onselectedindexchanged="lstItemDesc_SelectedIndexChanged"></asp:dropdownlist><asp:textbox id="txtItemDescpt" tabIndex="1" runat="server" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="100%" Height="50px" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 20%; HEIGHT: 30px"><asp:label id="Label8" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="100%">PL NO.</asp:label><asp:label id="Label7" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="100%" Visible="False">Master Item List</asp:label></TD>
									<TD style="WIDTH: 100%; HEIGHT: 19px" colSpan="3"><asp:textbox id="txtPLNO" tabIndex="2" runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue"
											Width="150px" MaxLength="10" Height="25px"></asp:textbox>&nbsp;
										<asp:dropdownlist onkeypress="return keySort(ddlMasterItems);" id="ddlMasterItems" tabIndex="4" runat="server"
											Font-Names="Verdana" Font-Size="7pt" ForeColor="DarkBlue" Width="100%" Height="25px" Visible="False"
								...
								<TR>
									...
									<TD style="WIDTH: 100%; HEIGHT: 19px" colSpan="3"><asp:dropdownlist id="ddlConsigneeCD" tabIndex="5" runat="server" Font-Names="Verdana" Font-Size="7pt"
								...
								<TR>
									...
									<TD style="WIDTH: 30%; HEIGHT: 19px"><asp:textbox id="txtQty" style="TEXT-ALIGN: right" tabIndex="6" runat="server" Font-Names="Verdana"
											Font-Size="8pt" ForeColor="DarkBlue" Width="50%" MaxLength="13" Height="20px"></asp:textbox></TD>
									...
									<TD style="WIDTH: 30%; HEIGHT: 19px"><asp:dropdownlist id="ddlUOMCode" tabIndex="7" runat="server" Font-Names="Verdana" Font-Size="8pt"
								...
								<TR>
									...
									<TD style="WIDTH: 30%; HEIGHT: 25px"><asp:textbox id="txtRate" onblur="basevalue();" style="TEXT-ALIGN: right" tabIndex="8" runat="server"
									...
									<TD style="WIDTH: 30%; HEIGHT: 25px">
										<P><asp:textbox id="txtBaseValue" onblur="basevalue();" style="TEXT-ALIGN: right" tabIndex="6" runat="server"
												Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="50%" MaxLength="14" Height="20px"></asp:textbox></P>
									</TD>
								</TR>
								<TR>
									...
									<TD style="FONT-WEIGHT: bold; FONT-SIZE: 8pt; WIDTH: 30%; COLOR: darkblue; FONT-FAMILY: Verdana; HEIGHT: 13px"><asp:dropdownlist id="ddlDiscountType" tabIndex="10" runat="server" Font-Names="Verdana" Font-Size="8pt"
										...
										<asp:textbox id="txtDiscountPer" onblur="discountype();" style="TEXT-ALIGN: right" tabIndex="11"
											runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="35%" MaxLength="10"
									...
									<TD style="WIDTH: 30%; HEIGHT: 13px"><asp:textbox id="txtDiscountAmt" onblur="discountype();" style="TEXT-ALIGN: right" tabIndex="12"
								...
								<TR>
									...
									<TD style="WIDTH: 30%">
										<P style="FONT-WEIGHT: bold; FONT-SIZE: 8pt; COLOR: darkblue; FONT-FAMILY: Verdana"><asp:dropdownlist id="ddlExciseType" tabIndex="13" runat="server" Font-Names="Verdana" Font-Size="8pt"
												ForeColor="DarkBlue" Width="42%" Height="25px">
												<asp:ListItem Selected="True"></asp:ListItem>
												<asp:ListItem Value="P">Percentage</asp:ListItem>
												<asp:ListItem Value="L">Lumpsum</asp:ListItem>
											</asp:dropdownlist>Value&nbsp;
											<asp:textbox id="txtExcise" onblur="excise();" style="TEXT-ALIGN: right" tabIndex="14" runat="server"
									...
									<TD style="WIDTH: 30%">
										<P><asp:textbox id="txtExciseAmt" onblur="excise();" style="TEXT-ALIGN: right" tabIndex="15" runat="server"
								...
								<TR>
									...
									<TD style="WIDTH: 30%; HEIGHT: 25px">
										<P><asp:textbox id="txtSaleTaxPre" onblur="saletax();" style="TEXT-ALIGN: right" tabIndex="16" runat="server"
									...
									<TD style="WIDTH: 30%; HEIGHT: 25px">
										<P><asp:textbox id="txtSaleTaxAmt" onblur="saletax();" style="TEXT-ALIGN: right" tabIndex="17" runat="server"
												Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="50%" MaxLength="11" Height="20px" ontextchanged="txtSaleTaxAmt_TextChanged"></asp:textbox></P>
									</TD>
								</TR>
								<TR>
									...
									<TD style="FONT-WEIGHT: bold; FONT-SIZE: 8pt; COLOR: darkblue; FONT-FAMILY: Verdana"><asp:dropdownlist id="ddlOCType" tabIndex="18" runat="server" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="42%" Height="25px">
											<asp:ListItem Selected="True"></asp:ListItem>
											<asp:ListItem Value="P">Percentage</asp:ListItem>
											<asp:ListItem Value="L">Lumpsum</asp:ListItem>
										...
										<asp:textbox id="txtOtherCharges" onblur="othercharges();" style="TEXT-ALIGN: right" tabIndex="19"
									...
									<TD style="WIDTH: 30%; HEIGHT: 2px"><asp:textbox id="txtOtherChargesAmt" onblur="saletax();" style="TEXT-ALIGN: right" tabIndex="20"
											runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="50%" MaxLength="11" Height="20px"></asp:textbox></TD>
								</TR>
								<TR>
									...
									<TD style="WIDTH: 30%; HEIGHT: 2px"><asp:textbox id="txtValue" style="TEXT-ALIGN: right" onfocus="total();" tabIndex="21" runat="server"
								...
								<TR>
									...
									<TD style="WIDTH: 30%">
										<P><asp:textbox id="txtDelvDate" onblur="cpy();" tabIndex="22" runat="server" Font-Names="Verdana"
									...
									<TD style="WIDTH: 30%">
										<P><asp:textbox id="txtExtDelvDate" onblur="check_date(txtExtDelvDate);compareDates(txtDelvDate,txtExtDelvDate,'Extended Delivery Date Cannot Be Less Then Delivery Date');"
												tabIndex="23" runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="35%"
				...
				<TR>
					<TD style="HEIGHT: 22px" align="center"><asp:button id="btnAdd" tabIndex="25" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
							ForeColor="DarkBlue" Width="58px" Visible="False" Text="Add" onclick="btnAdd_Click"></asp:button><asp:button id="btnSave" tabIndex="24" runat="server" Font-Bold="True" Font-Names="Verdana"
							Font-Size="8pt" ForeColor="DarkBlue" Width="61px" Text="Save" onclick="btnSave_Click"></asp:button><asp:button id="btnDelete" tabIndex="26" runat="server" Font-Bold="True" Font-Names="Verdana"
							Font-Size="8pt" ForeColor="DarkBlue" Width="58px" Visible="False" Text="Delete" onclick="btnDelete_Click"></asp:button><asp:button id="btnCancel" tabIndex="27" runat="server" Font-Bold="True" Font-Names="Verdana"
							Font-Size="8pt" ForeColor="DarkBlue" Width="58px" Text="Cancel" onclick="btnCancel_Click"></asp:button><asp:button id="btnSearch" tabIndex="28" runat="server" Font-Bold="True" Font-Names="Verdana"
							Font-Size="8pt" ForeColor="DarkBlue" Width="58px" Text="Search" onclick="btnSearch_Click"></asp:button><asp:button id="btnShowAll" tabIndex="29" runat="server" Font-Bold="True" Font-Names="Verdana"
					...
					<TD align="center"><asp:datagrid id="DgPO" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="100%" BorderColor="DarkBlue"
							...
							<Columns>
								<asp:TemplateColumn HeaderText="Item Sl. No.">
									...
									<ItemTemplate>
										<asp:HyperLink id=Hyperlink2 Text=' <%# DataBinder.Eval(Container.DataItem,"ITEM_SRNO")%>' Runat="server" NavigateUrl='<%#"PurchesOrderDetails.aspx?CASE_NO=" + DataBinder.Eval(Container.DataItem,"CASE_NO") + "&amp;ITEM_SRNO=" + DataBinder.Eval(Container.DataItem,"ITEM_SRNO") +"&amp;type="+ptype+"&amp;PODT="+PODT+"&amp;PO_OR_LOA="+po_or_loa %>'>
										</asp:HyperLink>
									</ItemTemplate>
								</asp:TemplateColumn>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Highlights_Form.aspx.cs" Inherits="RBS.Highlights_Form.Highlights_Form" %>
...
<HTML>
	<HEAD>
		...
		function validate()
		{
		 ...
		 {
		 alert("HIGHLIGHTS CANNOT BE LEFT BLANK");
					...
					<TR>
						<TD align="center" colspan="5">
							<P><asp:label id="Label1" runat="server" Font-Bold="True" Width="274px" BackColor="White" ForeColor="DarkBlue"
									Font-Size="10pt" Font-Names="Verdana">Highlights</asp:label></P>
						</TD>
					</TR>
					<TR>
								...
								<TBODY>
									...
									<TR>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="right"><B><FONT face="Verdana" color="darkblue" size="2">
													Highlights--&gt;<font color="red" size="1">*</font></FONT></B></TD>
										<TD style="WIDTH: 40.14%; HEIGHT: 150px" align="left" colspan="4"><B><FONT face="Verdana" color="darkblue" size="2">
													<asp:TextBox ID="Texthigh" Runat="server" MaxLength="2000" Width="90%" Height="150" TextMode="MultiLine"></asp:TextBox></FONT></B></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 100%; HEIGHT: 30px" align="center" colspan="5"><B><FONT face="Verdana" color="darkblue" size="2">
													<font color="red" size="1">* Kindly Enter Highlights for each month.</font></FONT></B></TD>
									</TR>
									<TR>

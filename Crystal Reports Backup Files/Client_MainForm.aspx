<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Client_MainForm.aspx.cs" Inherits="RBS.Client_MainForm.Client_MainForm" %>
...
//****************** Menu **********************************************
  Menu1=new Array("CLIENT WISE CALL STATUS","Reports/pfrmCallsStatusClientWise.aspx?Action=C","",0,20,200);
  Menu2=new Array("VENDORS PERFORMANCE","","",2,40,200);	
	Menu2_1=new Array("VENDOR WISE REJECTIONS","Reports/pfrmCallsStatusClientWise.aspx?Action=R","",0,20,200);	 
	Menu2_2=new Array("VENDOR WISE CALLS","Reports/pfrmVendorPerformance_Client.aspx","",0,20,200);	 
  Menu3=new Array("SPECIFIC PO CALL STATUS","Client_Calls_Marked_For_Specific_PO.aspx?ACTION=C","",0,20,200);	 
  Menu4=new Array("SPECIFIC PO IC STATUS","Client_Calls_Marked_For_Specific_PO.aspx?ACTION=I","",0,20,200);	
  Menu5=new Array("ADD MA","Client_MA_LIST.aspx","",0,20,150);	 

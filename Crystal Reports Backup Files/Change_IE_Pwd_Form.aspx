<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change_IE_Pwd_Form.aspx.cs" Inherits="RBS.Change_IE_Pwd_Form.Change_IE_Pwd_Form" %>

<%@ Register TagPrefix="uc1" TagName="WebUserControl1" Src="WebUserControl1.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Change IE Password Page</title>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="1" width="100%" bgColor="inactivecaptiontext"
								...
								<TR>
									<TD width="20%" noWrap align="right" colSpan="3" rowSpan="1">
										<asp:hyperlink id="HyperLink2" onclick="javascript:window.opener='x';window.close();" runat="server"
											Font-Names="Verdana" Font-Size="8pt" ForeColor="Purple" Font-Bold="True" NavigateUrl=" ">Exit</asp:hyperlink>
									</TD>
								</TR>
							</TABLE>
						</P>
					...
					<TD>
						<P align="center">
							<asp:Label id="Label1" runat="server" BackColor="White" Font-Names="Verdana" Font-Size="10pt"
								ForeColor="DarkBlue" Font-Bold="True">CHANGE IE PASSWORD FORM</asp:Label></P>
					</TD>
				</TR>
				<TR>
					<TD align="center">
						<P align="left">
							<asp:HyperLink id="hypLogin" runat="server" Font-Bold="True" Font-Size="8pt" Font-Names="Verdana"
								NavigateUrl="IE_Login_Form.aspx">Login Here</asp:HyperLink></P>
						<P>
								...
								<TR>
									...
									<TD>
										<asp:TextBox id="txtUID" tabIndex="1" runat="server" ForeColor="DarkBlue" Font-Size="8pt" Font-Names="Verdana"
											Width="150px" MaxLength="6" Height="20px"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 168px">
								...
								<TR>
									<TD style="WIDTH: 168px">
										<asp:Label id="Label6" runat="server" ForeColor="DarkBlue" Font-Size="8pt" Font-Names="Verdana"
											Width="160px" Font-Bold="True">Confirm New Password</asp:Label></TD>
									<TD>

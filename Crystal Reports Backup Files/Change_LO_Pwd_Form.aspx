<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change_LO_Pwd_Form.aspx.cs" Inherits="RBS.Change_LO_Pwd_Form.Change_LO_Pwd_Form" %>
...
<HTML>
  <HEAD>
		<title>Client Change Password Form</title>
					...
					<TD align="center">
						<P align="left">
							<asp:HyperLink id="hypLogin" runat="server" Font-Bold="True" Font-Size="8pt" Font-Names="Verdana"
								NavigateUrl="LO_Login_Form.aspx">Login Here</asp:HyperLink></P>
						<P>
							<TABLE id="Table2" style="WIDTH: 363px; HEIGHT: 216px" cellSpacing="1" cellPadding="1"
								...
								<TR>
									...
									<TD>
										<asp:TextBox id="txtOPwd" tabIndex="3" runat="server" ForeColor="DarkBlue" Font-Size="8pt" Font-Names="Verdana"
											Width="150px" MaxLength="10" TextMode="Password" Height="20px"></asp:TextBox></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 176px">
								...
								<TR>
									<TD style="WIDTH: 176px">
										<asp:Label id="Label6" runat="server" ForeColor="DarkBlue" Font-Size="8pt" Font-Names="Verdana"
											Width="160px" Font-Bold="True">Confirm New Password<FONT face="Verdana" color="orangered" size="1">* </FONT></asp:Label></TD>
									<TD>
								...
								<TR>
									<TD colspan="2" align="center"><P><B><FONT face="Verdana" color="orangered" size="1">* New 
													Password must be maximum of&nbsp;10 characters.</FONT></B>
										</P>
									</TD>
								</TR>
							</TABLE>

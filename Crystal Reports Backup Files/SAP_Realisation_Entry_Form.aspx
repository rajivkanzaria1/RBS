<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAP_Realisation_Entry_Form.aspx.cs" Inherits="RBS.SAP_Realisation_Entry_Form.SAP_Realisation_Entry_Form" %>
					...
					<TR>
						<TD align="center" colspan="5" style="HEIGHT: 17px">
							<P><asp:label id="Label1" runat="server" Font-Bold="True" Width="274px" BackColor="White" ForeColor="DarkBlue"
									Font-Size="10pt" Font-Names="Verdana">SAP REALISATION ENTRY FORM</asp:label></P>
						</TD>
					</TR>
					<TR>
								...
								<TBODY>
									...
									<TR>
										...
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="left" colSpan="4">
											<asp:dropdownlist id="lstClientType" tabIndex="1" runat="server" Font-Names="Verdana" Font-Size="8pt"
												ForeColor="DarkBlue" Width="20%" AutoPostBack="True"></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="right"><B><FONT face="Verdana" color="darkblue" size="2">
													Total Amount(In Rs.) --&gt;<font color="red" size="1">*</font></FONT></B></TD>

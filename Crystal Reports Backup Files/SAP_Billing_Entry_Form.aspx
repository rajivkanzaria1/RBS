<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAP_Billing_Entry_Form.aspx.cs" Inherits="RBS.SAP_Billing_Entry_Form.SAP_Billing_Entry_Form" %>
...
<HTML>
	<HEAD>
		<title>SAP_Billing_Entry_Form</title>
					...
					<TR>
						<TD align="center" colspan="5" style="HEIGHT: 17px">
							<P><asp:label id="Label1" runat="server" Font-Bold="True" Width="274px" BackColor="White" ForeColor="DarkBlue"
									Font-Size="10pt" Font-Names="Verdana">SAP BILLING ENTRY FORM</asp:label></P>
						</TD>
					</TR>
					<TR>
								...
								<TBODY>
									...
									<TR>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="right"><B><FONT face="Verdana" color="darkblue" size="2">
													Total Insp&nbsp;Fee(In Rs.) --&gt;<font color="red" size="1">*</font></FONT></B></TD>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="left" colspan="4"><B><FONT face="Verdana" color="darkblue" size="2">
													<asp:TextBox ID="Textamt" Runat="server" MaxLength="13" onkeyup="integersOnly(this)"></asp:TextBox><font color="red" size="1">(Only 
														Numeric Value Allowed)</font></FONT></B></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="right"><B><FONT face="Verdana" color="darkblue" size="2">
													Total CGST(In Rs.) --&gt;<font color="red" size="1">*</font></FONT></B></TD>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="left" colspan="4"><B><FONT face="Verdana" color="darkblue" size="2">
													<asp:TextBox ID="txtCGST" Runat="server" MaxLength="13" onkeyup="integersOnly(this)"></asp:TextBox><font color="red" size="1">(Only 
														Numeric Value Allowed)</font></FONT></B></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="right"><B><FONT face="Verdana" color="darkblue" size="2">
													Total SGST(In Rs.) --&gt;<font color="red" size="1">*</font></FONT></B></TD>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="left" colspan="4"><B><FONT face="Verdana" color="darkblue" size="2">
													<asp:TextBox ID="txtSGST" Runat="server" MaxLength="13" onkeyup="integersOnly(this)"></asp:TextBox><font color="red" size="1">(Only 
														Numeric Value Allowed)</font></FONT></B></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="right"><B><FONT face="Verdana" color="darkblue" size="2">
													Total IGST(In Rs.) --&gt;<font color="red" size="1">*</font></FONT></B></TD>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="left" colspan="4"><B><FONT face="Verdana" color="darkblue" size="2">
													<asp:TextBox ID="txtIGST" Runat="server" MaxLength="13" onkeyup="integersOnly(this)"></asp:TextBox><font color="red" size="1">(Only 
														Numeric Value Allowed)</font></FONT></B></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="right"></TD>
										<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="left" colSpan="4"></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 100%; HEIGHT: 30px" align="center" colspan="5"><B><FONT face="Verdana" color="darkblue" size="2">
													<font color="red" size="1">* Kindly SAP Billing for each month to calculate the 
														Difference From IBS Billing, Plz Enter Carefully, once Entered Cannot be 
														Modified.</font></FONT></B></TD>
									</TR>
									<TR>

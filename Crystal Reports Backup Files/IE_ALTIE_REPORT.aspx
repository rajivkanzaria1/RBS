<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IE_ALTIE_REPORT.aspx.cs" Inherits="RBS.IE_ALTIE_REPORT.IE_ALTIE_REPORT" %>

<%@ Register TagPrefix="uc1" TagName="WebUserControl1" Src="WebUserControl1.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>IE_ALTIE_REPORT</title>
					...
					<TR>
						<TD style="HEIGHT: 25px" align="center" colSpan="2">
							<P><asp:label id="Label1" runat="server" Font-Size="10pt" Font-Names="Verdana" Font-Bold="True"
									ForeColor="DarkBlue" BackColor="White" Width="374px">IE'S-ALTIE LIST REPORT</asp:label></P>
						</TD>
					</TR>
					<tr>
						<TD></TD>
					...
					<TR bgColor="#f0f8ff">
						<TD style="WIDTH:10%">
							<P><asp:radiobutton id="rdbForMonth" runat="server" Font-Size="8pt" Font-Names="Verdana" Font-Bold="True"
									ForeColor="DarkBlue" Width="100%" Text="Show LIST of IE -ALTIE " AutoPostBack="True" GroupName="g1"

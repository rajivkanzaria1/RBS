<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Outstanding_LY_Form.aspx.cs" Inherits="RBS.Outstanding_LY_Form.Outstanding_LY_Form" %>
...
<HTML>
  <HEAD>
    <title>Outstanding_LY_Form</title>
    ...
    <script src="date.js"></script>
		...
		function validate()
		{
		 ...
		 {
		 alert("OUTSTANDING AMOUNT CANNOT BE LEFT BLANK");
  ...
  <body>
    ...
    <TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px; HEIGHT: 123px"
				...
				<TBODY>
					...
					<TR>
						<TD align="center" colspan="5">
							<P><asp:label id="Label1" runat="server" Font-Bold="True" Width="274px" BackColor="White" ForeColor="DarkBlue"
									Font-Size="10pt" Font-Names="Verdana">Last Year Current Month Outstanding</asp:label></P>
						</TD>
					</TR>
					...
					<TR>
						<TD style="WIDTH: 40.14%; HEIGHT: 61px" align="right"><B><FONT face="Verdana" color="darkblue" size="2"> Outstanding&nbsp;Amount
									(In Rs.) --&gt;<font color="red" size="1">*</font></FONT></B></TD>
					...
					<TR>
						...
						<font color="red" size="1">* Kindly Enter&nbsp;Outstanding for each month to calculate the Cummulative Figures in PCDO Reports for the Last&nbsp; Year.</font></FONT></B></TD>

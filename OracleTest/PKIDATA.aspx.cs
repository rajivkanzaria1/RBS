...
namespace RBS.PKIDATA
{
	public partial class PKIDATA : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				if (Request.Form["file"] != null)
				{
					...
					//DisplayAlert(filename);
					using (StreamWriter writetext = new StreamWriter(Server.MapPath("IC_XML/" + filename + ".xml")))
					{

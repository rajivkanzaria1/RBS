...
namespace RBS.Correction_To_Inspection_Certificate_Edit_Form
{
	public partial class Correction_To_Inspection_Certificate_Edit_Form : System.Web.UI.Page
	{
		...
		protected Tittle.Controls.CustomDataGrid grdIC;
		...
		private void btnAdd_Click(object sender, System.EventArgs e)
		{
			...
			if (check == "2")
			{
				...
				Response.Redirect("Correction_To_Inspection_Certificate_Form.aspx?Action=A&Case_No=" + code + "&CALL_RECV_DT=" + dt + "&CALL_SNO=" + csno);
			}
			//			else
			//			{
		...
		private void btnMod_Click(object sender, System.EventArgs e)
		{
			...
			if (check == "2")
			{
				...
				Response.Redirect("Correction_To_Inspection_Certificate_Form.aspx?Action=M&BK_NO=" + bkno + "&SET_NO=" + sno);
			}
			//			else
			//			{
		...
		private void btnSearch_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				string str1 = "Select IC_NO, CASE_NO, BK_NO,SET_NO,STATUS,to_char(CALL_RECV_DATE,'dd/mm/yyyy') CALL_RECV_DT,CALL_SNO,IE_SNAME,CONSIGNEE from(";
				...
				str1 = str1 + " and T17.REGION_CODE='" + Session["Region"].ToString() + "' and T17.CALL_STATUS <> 'C' Group By T18.CASE_NO,T18.CALL_RECV_DT,T18.CALL_SNO,T20.IC_NO,T20.BK_NO,T20.SET_NO,NVL2(T20.BILL_NO,'Bill No:'||T20.BILL_NO,'Bill Pending'), T09.IE_SNAME," +
								"(T06.CONSIGNEE_CD||'-'||nvl2(trim(T06.CONSIGNEE_DESIG),trim(T06.CONSIGNEE_DESIG)||'/','')||nvl2(trim(T06.CONSIGNEE_DEPT),trim(T06.CONSIGNEE_DEPT)||'/','')||nvl2(trim(T06.CONSIGNEE_FIRM),trim(T06.CONSIGNEE_FIRM)||'/','')||NVL2(trim(T06.CONSIGNEE_ADD1),trim(T06.CONSIGNEE_ADD1)||'/','')||NVL2(trim(T03.LOCATION),trim(T03.LOCATION)||' : '||trim(T03.CITY),trim(T03.CITY)))";

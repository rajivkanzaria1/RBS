...
{
	public partial class Central_QOII : System.Web.UI.Page
	{
		...
		protected void btnSave_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				string Expcheckquery = "Select count(*) from T79_CENTRAL_QOINSP where QOI_DATE='" + wYrMth + "' and REGION='" + Session["Region"].ToString() + "' and CLIENT='" + lstclient.SelectedValue + "' and WEIGHT='" + lstweight.SelectedValue + "' and QOI_LENGTH='" + lsthieght.SelectedValue + "'";
				...
				{
					string Expquery = "insert into T79_CENTRAL_QOINSP(CLIENT, WEIGHT, QOI_LENGTH, ACCEPTED, REJECTED, QOI_DATE, REGION, USER_ID, DATETIME) " +
						"VALUES('" + lstclient.SelectedValue + "','" + lstweight.SelectedValue + "','" + lsthieght.SelectedValue + "','" + Convert.ToInt64(Textacc.Text) + "','" + Convert.ToInt64(Textrej.Text) + "','" + wYrMth + "','" + Session["Region"].ToString() + "','" + Session["Uname"].ToString() + "',to_date('" + ss + "','dd/mm/yyyy-HH24:MI:SS'))";

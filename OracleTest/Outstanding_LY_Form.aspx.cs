...
namespace RBS.Outstanding_LY_Form
{
	public partial class Outstanding_LY_Form : System.Web.UI.Page
	{
		...
		protected void btnSave_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				string Expcheckquery = "Select count(*) from T84_OUTS_LY where LY_PER= '" + wYrMth + "' and region_code='" + Session["Region"].ToString() + "'";
				...
				{
					string Expquery = "insert into T84_OUTS_LY(LY_PER,LY_OUTS,REGION_CODE,USER_ID,DATETIME) " +
						"VALUES('" + wYrMth + "','" + Convert.ToDecimal(TextExpamt.Text) + "','" + Session["Region"].ToString() + "','" + Session["Uname"].ToString() + "',to_date('" + ss + "','dd/mm/yyyy-HH24:MI:SS'))";

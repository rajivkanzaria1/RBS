<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DEO_CRIS_PurchesOrderDetails.aspx.cs" Inherits="RBS.DEO_CRIS_PurchesOrderDetails.DEO_CRIS_PurchesOrderDetails" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 100%; POSITION: absolute; TOP: 8px; HEIGHT: 123px"
							...
							<TABLE id="Table2" style="WIDTH: 100%; HEIGHT: 276px" borderColor="#b0c4de" cellSpacing="1"
								...
								<TR>
									<TD style="WIDTH: 20%; HEIGHT: 27px" vAlign="baseline" align="left"><asp:label id="lblCasNo" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="100%"> IMMS PO KEY.</asp:label></TD>
									...
									<TD style="WIDTH: 20%; HEIGHT: 27px" vAlign="middle" align="left"><asp:label id="Label8" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="48px">RLY CD.  </asp:label></TD>
									<TD style="WIDTH: 30%; HEIGHT: 27px"><asp:textbox id="txtPODT" style="TEXT-ALIGN: right" tabIndex="6" runat="server" BackColor="AliceBlue"
											Width="1px" BorderColor="AliceBlue" MaxLength="14" Height="1px"></asp:textbox><asp:label id="lblRCD" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="OrangeRed" Width="112px"></asp:label><asp:label id="lblIRCD" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="OrangeRed" Width="112px" Visible="False"></asp:label></TD>
								</TR>
								<TR>
									...
									<TD style="HEIGHT: 30%"><asp:textbox id="txtItemDescpt" tabIndex="1" runat="server" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="100%" Height="50px" Enabled="False" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 20%; HEIGHT: 30px"><asp:label id="Label10" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="100%">PL NO.</asp:label></TD>
									<TD style="WIDTH: 100%; HEIGHT: 19px" colSpan="3"><asp:textbox id="txtPLNO" tabIndex="2" runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue"
											Width="150px" MaxLength="10" Height="25px"></asp:textbox><asp:label id="lblMasterItem" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="100%" Visible="False"></asp:label></TD>
								</TR>
								<TR>
									...
									<TD style="WIDTH: 100%; HEIGHT: 19px" colSpan="3"><asp:textbox id="txtSBPO" tabIndex="2" runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue"
											...
											ForeColor="DarkBlue" Width="100%" Height="25px" onChange="BPOVisible();"></asp:dropdownlist><asp:textbox id="txtBPO" tabIndex="5" runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue"
								...
								<TR>
									...
									<TD style="WIDTH: 100%; HEIGHT: 19px" colSpan="3"><asp:textbox id="txtSCon" tabIndex="6" runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue"
											...
											ForeColor="DarkMagenta" Width="238px">* In Case Of other Client</asp:label><asp:label id="lblIMMS_CON_CD" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="OrangeRed" Width="112px" Visible="False"></asp:label><asp:dropdownlist onkeypress="return keySort(ddlConsigneeCD);" id="ddlConsigneeCD" tabIndex="8" runat="server"
											Font-Names="Verdana" Font-Size="7pt" ForeColor="DarkBlue" Width="100%" Height="25px"></asp:dropdownlist><asp:textbox id="txtConsignee" tabIndex="9" runat="server" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="95%" MaxLength="300"></asp:textbox></TD>
								</TR>
								<TR>
									...
									<TD style="WIDTH: 30%; HEIGHT: 19px"><asp:textbox id="txtQty" style="TEXT-ALIGN: right" tabIndex="10" runat="server" Font-Names="Verdana"
											Font-Size="8pt" ForeColor="DarkBlue" Width="50%" MaxLength="12" Height="20px" Enabled="False"></asp:textbox></TD>
									...
									<TD style="WIDTH: 30%; HEIGHT: 19px"><asp:dropdownlist id="ddlUOMCode" tabIndex="11" runat="server" Font-Names="Verdana" Font-Size="8pt"
											...
											Font-Size="8pt" ForeColor="AliceBlue" Width="1px" MaxLength="10" BorderStyle="None"></asp:textbox><asp:label id="lblUOM" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="OrangeRed" Width="112px"></asp:label></TD>
								</TR>
								<TR>
									...
									<TD style="WIDTH: 30%; HEIGHT: 25px"><asp:textbox id="txtRate" onblur="basevalue();" style="TEXT-ALIGN: right" tabIndex="12" runat="server"
											Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="50%" MaxLength="12" Height="20px" Enabled="False"></asp:textbox></TD>
									...
									<TD style="WIDTH: 30%; HEIGHT: 25px">
										<P><asp:textbox id="txtBaseValue" onblur="basevalue();" style="TEXT-ALIGN: right" tabIndex="13"
												...
												Height="20px" Enabled="False"></asp:textbox></P>
									</TD>
								</TR>
								<TR>
									...
									<TD style="FONT-WEIGHT: bold; FONT-SIZE: 8pt; WIDTH: 30%; COLOR: darkblue; FONT-FAMILY: Verdana; HEIGHT: 13px"><asp:dropdownlist id="ddlDiscountType" tabIndex="14" runat="server" Font-Names="Verdana" Font-Size="8pt"
											ForeColor="DarkBlue" Width="42%" Height="25px" Enabled="False">
										...
										<asp:textbox id="txtDiscountPer" onblur="discountype();" style="TEXT-ALIGN: right" tabIndex="8"
											...
											Height="20px" Enabled="False"></asp:textbox></TD>
									...
									<TD style="WIDTH: 30%; HEIGHT: 13px"><asp:textbox id="txtDiscountAmt" onblur="discountype();" style="TEXT-ALIGN: right" tabIndex="9"
											runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="50%" MaxLength="16" Height="20px" Enabled="False"></asp:textbox></TD>
								</TR>
								<TR>
									...
									<TD style="WIDTH: 30%">
										<P style="FONT-WEIGHT: bold; FONT-SIZE: 8pt; COLOR: darkblue; FONT-FAMILY: Verdana"><asp:dropdownlist id="ddlExciseType" tabIndex="17" runat="server" Font-Names="Verdana" Font-Size="8pt"
											...
											<asp:textbox id="txtExcise" onblur="excise();" style="TEXT-ALIGN: right" tabIndex="18" runat="server"
												Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="35%" MaxLength="10" Height="20px"
									...
									<TD style="WIDTH: 30%">
										<P><asp:textbox id="txtExciseAmt" onblur="excise();" style="TEXT-ALIGN: right" tabIndex="19" runat="server"
												Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="50%" MaxLength="11" Height="20px"
												Enabled="False"></asp:textbox></P>
									</TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD style="WIDTH: 30%; HEIGHT: 2px"><asp:textbox id="txtOtherChargesAmt" onblur="saletax();" style="TEXT-ALIGN: right" tabIndex="24"
											runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="50%" MaxLength="11" Height="20px" Enabled="False"></asp:textbox></TD>
								</TR>
								<TR>
									...
									<TD style="WIDTH: 30%; HEIGHT: 2px"><asp:textbox id="txtValue" style="TEXT-ALIGN: right" onfocus="total();" tabIndex="25" runat="server"
											Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue" Width="50%" MaxLength="16" Height="20px" Enabled="False"></asp:textbox></TD>
								</TR>
								<TR>
									...
									<TD style="WIDTH: 30%">
										<P><asp:textbox id="txtDelvDate" onblur="cpy();" tabIndex="26" runat="server" Font-Names="Verdana"
												Font-Size="8pt" ForeColor="DarkBlue" Width="40%" MaxLength="10" Height="20px" Enabled="False"></asp:textbox></P>
									</TD>
									...
									<TD style="WIDTH: 30%">
										<P><asp:textbox id="txtExtDelvDate" onblur="check_date(txtExtDelvDate);compareDates(txtDelvDate,txtExtDelvDate,'Extended Delivery Date Cannot Be Less Then Delivery Date');"
												...
												MaxLength="10" Height="20px" Enabled="False"></asp:textbox><asp:label id="lblOldConCD" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="8pt"
				...
				<TR>
					<TD style="HEIGHT: 22px" align="center"><asp:button id="btnSave" tabIndex="29" runat="server" Width="61px" ForeColor="DarkBlue" Font-Size="8pt"
							Font-Names="Verdana" Font-Bold="True" Text="Save" onclick="btnSave_Click"></asp:button><asp:button id="btnCancel" tabIndex="31" runat="server" Width="58px" ForeColor="DarkBlue" Font-Size="8pt"
							Font-Names="Verdana" Font-Bold="True" Text="Cancel" onclick="btnCancel_Click"></asp:button></TD>
					</TD></TR>
				<TR>
					<TD align="center"><asp:datagrid id="DgPO" runat="server" Width="100%" Font-Size="8pt" Font-Names="Verdana" Height="96px"
							...
							<Columns>
								<asp:TemplateColumn HeaderText="Item Sl. No.">
									...
									<ItemTemplate>
										<asp:HyperLink id="Hyperlink2" NavigateUrl='<%#"DEO_CRIS_PurchesOrderDetails.aspx?IMMS_POKEY=" + DataBinder.Eval(Container.DataItem,"IMMS_POKEY") + "&amp;ITEM_SRNO=" + DataBinder.Eval(Container.DataItem,"ITEM_SRNO") +"&amp;IMMS_RLY_CD="+DataBinder.Eval(Container.DataItem,"IMMS_RLY_CD") %>' Runat="server" Text=' <%# DataBinder.Eval(Container.DataItem,"ITEM_SRNO")%>'>
										</asp:HyperLink>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:BoundColumn Visible="False" DataField="IMMS_POKEY" HeaderText="IMMS_POKEY">

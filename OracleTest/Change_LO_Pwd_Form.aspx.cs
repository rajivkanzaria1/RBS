...
namespace RBS.Change_LO_Pwd_Form
{
	public partial class Change_LO_Pwd_Form : System.Web.UI.Page
	{
		...
		protected void btnSubmit_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				string str3 = "select PWD from T105_LO_LOGIN where (MOBILE='" + txtUID.Text + "' and PWD='" + txtOPwd.Text + "')";
				...
				{
					string myUpdateQuery = "Update T105_LO_LOGIN set PWD ='" + txtNPwd.Text + "' where MOBILE='" + txtUID.Text + "'";

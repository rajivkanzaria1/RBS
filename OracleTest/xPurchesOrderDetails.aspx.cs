...
{
	public class PurchesOrderDetails : System.Web.UI.Page
	{
		OracleConnection conn1 = new OracleConnection(ConfigurationManager.ConnectionStrings["MyConnection"].ConnectionString);
		protected System.Web.UI.WebControls.DataGrid DgPO;
		protected System.Web.UI.WebControls.Label lblItemSLNo;
		protected System.Web.UI.WebControls.Label lblCasNo;
		protected System.Web.UI.WebControls.Label lblQty;
		protected System.Web.UI.WebControls.Label lblOtherCharges;
		protected System.Web.UI.WebControls.Button btnDelete;
		protected System.Web.UI.WebControls.Button btnSave;
		protected System.Web.UI.WebControls.Label Label1;
		protected System.Web.UI.WebControls.TextBox txtItemDescpt;
		protected System.Web.UI.WebControls.Label lblItemDescpt;
		protected System.Web.UI.WebControls.TextBox txtItemSLNo;
		...
		protected System.Web.UI.WebControls.Label lblDiscountPercentage;
		protected System.Web.UI.WebControls.Label lblDelvDate;
		protected System.Web.UI.WebControls.TextBox txtDelvDate;
		protected System.Web.UI.WebControls.TextBox txtExtDelvDate;
		protected System.Web.UI.WebControls.Label tlblExtDelvDate;
		public string CASE_NO, ITEM_SRNO, PODT;
		static string CsNo;
		protected System.Web.UI.WebControls.Label lblDiscountAmt;
		protected System.Web.UI.WebControls.Label lblExcisePr;
		protected System.Web.UI.WebControls.Label lblExciseAmt;
		protected System.Web.UI.WebControls.TextBox txtExcise;
		protected System.Web.UI.WebControls.TextBox txtExciseAmt;
		protected System.Web.UI.WebControls.Button btnCancel;
		protected System.Web.UI.WebControls.Label lblUMOCode;
		protected System.Web.UI.WebControls.DropDownList ddlUOMCode;
		protected System.Web.UI.WebControls.Label lblRate;
		protected System.Web.UI.WebControls.TextBox txtRate;
		protected System.Web.UI.WebControls.Label Label2;
		protected System.Web.UI.WebControls.Label lblSaleTaxPr;
		protected System.Web.UI.WebControls.Label lblBsValue;
		protected System.Web.UI.WebControls.TextBox txtBaseValue;
		protected System.Web.UI.WebControls.TextBox txtSaleTaxPre;
		protected System.Web.UI.WebControls.TextBox txtDiscountPer;
		protected System.Web.UI.WebControls.TextBox txtDiscountAmt;
		protected System.Web.UI.WebControls.Label lblSaleTaxAmt;
		protected System.Web.UI.WebControls.TextBox txtSaleTaxAmt;
		string CD, ss;
		public string ptype;
		protected System.Web.UI.WebControls.TextBox txtUOMFactor;
		protected System.Web.UI.WebControls.Button btnAdd;
		protected System.Web.UI.WebControls.DropDownList ddlDiscountType;
		protected System.Web.UI.WebControls.DropDownList ddlExciseType;
		protected System.Web.UI.WebControls.Label Label4;
		protected System.Web.UI.WebControls.Label lblPODT;
		protected System.Web.UI.WebControls.TextBox txtPODT;
		protected System.Web.UI.WebControls.TextBox txtOtherCharges;
		protected System.Web.UI.WebControls.DropDownList ddlOCType;
		protected System.Web.UI.WebControls.Label Label5;
		protected System.Web.UI.WebControls.TextBox txtOtherChargesAmt;
		protected System.Web.UI.WebControls.Label lblOldConCD;
		...
		{
			this.ddlUOMCode.SelectedIndexChanged += new System.EventHandler(this.ddlUOMCode_SelectedIndexChanged);
		...
		public void save()
		{
			...
			try
			{
				...
				OracleCommand cmd1 = new OracleCommand("insert into T15_PO_DETAIL(CASE_NO, ITEM_SRNO, ITEM_DESC, CONSIGNEE_CD, QTY, RATE, UOM_CD, BASIC_VALUE, SALES_TAX_PER, SALES_TAX, EXCISE_TYPE, EXCISE_PER,EXCISE, DISCOUNT_TYPE, DISCOUNT_PER, DISCOUNT, OT_CHARGE_TYPE,OT_CHARGE_PER,OTHER_CHARGES, VALUE, DELV_DT, EXT_DELV_DT, USER_ID, DATETIME) values('" + Label2.Text + "','" + txtItemSLNo.Text + "',upper('" + txtItemDescpt.Text + "'),'" + ddlConsigneeCD.SelectedItem.Value + "','" + txtQty.Text + "','" + txtRate.Text + "','" + ddlUOMCode.SelectedItem.Value + "','" + txtBaseValue.Text + "','" + txtSaleTaxPre.Text + "','" + txtSaleTaxAmt.Text + "','" + ddlExciseType.SelectedValue + "','" + txtExcise.Text + "','" + txtExciseAmt.Text + "','" + ddlDiscountType.SelectedValue + "','" + txtDiscountPer.Text + "','" + txtDiscountAmt.Text + "','" + ddlOCType.SelectedValue + "'," + txtOtherCharges.Text + "," + txtOtherChargesAmt.Text + ",'" + txtValue.Text + "',to_date('" + txtDelvDate.Text + "','dd/mm/yyyy'),to_date('" + txtExtDelvDate.Text + "','dd/mm/yyyy'),'" + Session["Uname"] + "', to_date('" + ss + "','dd/mm/yyyy-HH:MI:SS'))", conn1);
		...
		public void update()
		{
			...
			try
			{
				...
				if (nos > 0)
				{
					OracleCommand cmd2 = new OracleCommand("update T18_CAll_DETAILS set ITEM_DESC_PO=upper('" + txtItemDescpt.Text + "'),QTY_ORDERED ='" + txtQty.Text + "',USER_ID='" + Session["UName"] + "', DATETIME=to_date('" + ss + "','dd/mm/yyyy-HH:MI:SS') where CASE_NO = '" + Label2.Text + "' And ITEM_SRNO_PO = " + txtItemSLNo.Text + "", conn1);
					...
					//					if(bills>0)
					//					{
					//						OracleCommand cmd4 =new OracleCommand("update T22_BILL set BILL_STATUS='E',USER_ID='"+Session["UName"] +"', DATETIME=to_date('" +ss+ "','dd/mm/yyyy-HH:MI:SS') where BILL_NO IN (Select M.BILL_NO From T23_BILL_ITEMS D,T22_BILL M where D.BILL_NO=M.BILL_NO AND M.CASE_NO = '" + Label2.Text + "' And D.ITEM_SRNO= " + txtItemSLNo.Text+")",conn1);
		...
		private void ddlUOMCode_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			getuomfactor();

...
{
	public partial class Client_Calls_Marked_For_Specific_PO : System.Web.UI.Page
	{
		...
		{
			wCallCtr = 0;
			CLT = Session["ORGN_TYPE"].ToString();
			RLYCD = Session["ORGN"].ToString();
			if (PNO == "")
			{
				PNO = PNO;
				PDT = txtPODT.Text;
			...
			string sql = "Select trim(T051.VEND_NAME)||nvl2(trim(T03.CITY),','||trim(T03.CITY),'') VENDOR,trim(T052.VEND_NAME)||nvl2(trim(T032.CITY),','||trim(T032.CITY),'') MANUFACTURER,T051.VEND_CD VEND_CD,T052.VEND_CD MFG_CD," +
				...
				"T09.IE_NAME,T09.IE_PHONE_NO,T13.PO_NO,to_char(T13.PO_DT,'dd/mm/yyyy')PO_DATE,T17.CASE_NO,T17.REMARKS REMARK,TO_CHAR(DT_INSP_DESIRE,'DD/MM/YYYY') DESIRE_DT, " +
				...
				"(trim(upper(T13.L5NO_PO))='" + PNO.Trim().ToUpper() + "' and TO_CHAR(T13.PO_DT,'dd/mm/yyyy')='" + PDT + "') and ((RLY_NONRLY='R') OR (T13.RLY_NONRLY='" + CLT + "' and T13.RLY_CD = '" + RLYCD + "')) and " +
			...
			try
			{
				...
				Response.Write("<th width='6%' valign='top'><b><font size='1' face='Verdana'>DESIRE DATE/MATERIAL READINESS DATE</font></b></th>");
				...
				while (reader.Read())
				{
					...
					Response.Write("<td width='6%' valign='top'> <font size='1' face='Verdana'>"); Response.Write(reader["DESIRE_DT"]); Response.Write("</td>");
		...
		void inspection_details()
		{
			...
			str = str + " and (trim(upper(T13.L5NO_PO)))='" + PNO.Trim().ToUpper() + "' and TO_CHAR(T13.PO_DT,'dd/mm/yyyy')='" + PDT + "' and ((RLY_NONRLY='R') OR (T13.RLY_NONRLY='" + CLT + "' and T13.RLY_CD ='" + RLYCD + "')) ";
			...
			string sql = "Select trim(T051.VEND_NAME)||nvl2(trim(T03.CITY),','||trim(T03.CITY),'') VENDOR,trim(T052.VEND_NAME)||nvl2(trim(T032.CITY),','||trim(T032.CITY),'') MANUFACTURER,T051.VEND_CD VEND_CD,T052.VEND_CD MFG_CD," +
				...
				"Where  T051.VEND_CD=T13.VEND_CD and  T06.CONSIGNEE_CD(+)=T13.PURCHASER_CD and  T13.CASE_NO=T17.CASE_NO and T17.CALL_STATUS=T21.CALL_STATUS_CD and " +
				"T09.IE_CD =T17.IE_CD  and  T18.CASE_NO=T17.CASE_NO and T18.CALL_RECV_DT=T17.CALL_RECV_DT and T18.CALL_SNO=T17.CALL_SNO and T17.MFG_CD=T052.VEND_CD(+) and " +
				"(trim(upper(T13.L5NO_PO))='" + PNO.Trim().ToUpper() + "' and TO_CHAR(T13.PO_DT,'dd/mm/yyyy')='" + PDT + "') and ((RLY_NONRLY='R' and RLY_CD IN ('ICF','RB')) OR (T13.RLY_NONRLY='" + CLT + "' and T13.RLY_CD='" + RLYCD + "')) and T17.CALL_STATUS NOT IN ('M','B') and (sysdate-T17.CALL_RECV_DT)<90 and " +
				"T18.ITEM_SRNO_PO=(Select min(B.ITEM_SRNO_PO) from T18_CALL_DETAILS B where B.CASE_NO=T18.CASE_NO AND B.CALL_RECV_DT=T18.CALL_RECV_DT AND B.CALL_SNO=T18.CALL_SNO) and  " +
				"T03.CITY_CD=T051.VEND_CITY_CD and T032.CITY_CD(+)=T052.VEND_CITY_CD and T08.CO_CD(+)=T09.IE_CO_CD ";
			sql = sql + "Order by T17.CALL_MARK_DT DESC,T051.VEND_NAME";
			wSortHdr = "Report Sorted on Call Date (Descending)";
			...
			try
			{
				...
				Response.Write("<table border='1' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#111111' width='130%'>");
				Response.Write("<tr>"); Response.Write("<td width='100%' bgcolor='#FFFFCC' colspan='20'>");
				Response.Write("<p align='center'><font face='Verdana' color='#3333FF'><b>");
				//Response.Write("<font size='4'>CALLS  DETAILS FOR SPECIFIC PO FOR THE PERIOD "+wFrmDt+" TO "+wToDt+"  </b></font><br>");
				...
				while (reader1.Read())
				{
					...
					Response.Write("<td width='6%' valign='top'> <font size='1' face='Verdana'>"); Response.Write(reader1["DESIRE_DT"]); Response.Write("</td>");
		...
		protected void btnSearch_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				string str1 = "";
				if (Session["ORGN_TYPE"].ToString() == "U" && Session["ORGN"].ToString().Trim() == "SAIL")
				{
					str1 = "select L5NO_PO,PO_NO,to_char(PO_DT,'dd/mm/yyyy')PO_DT,RLY_NONRLY,RLY_CD from T13_PO_MASTER T13, T17_CALL_REGISTER T17 where T13.CASE_NO=T17.CASE_NO and ((RLY_NONRLY='" + Session["ORGN_TYPE"].ToString() + "' and RLY_CD='" + Session["ORGN"].ToString() + "') OR (RLY_NONRLY='R')) and TO_CHAR(PO_DT,'dd/mm/yyyy')='" + txtPODT.Text.Trim() + "'";
				}
				else
				{
					str1 = "select L5NO_PO,PO_NO,to_char(PO_DT,'dd/mm/yyyy')PO_DT,RLY_NONRLY,RLY_CD from T13_PO_MASTER T13, T17_CALL_REGISTER T17 where T13.CASE_NO=T17.CASE_NO and ((RLY_NONRLY='" + Session["ORGN_TYPE"].ToString() + "' and RLY_CD='" + Session["ORGN"].ToString() + "') OR (RLY_NONRLY='R' and RLY_CD IN ('ICF','RB'))) and TO_CHAR(PO_DT,'dd/mm/yyyy')='" + txtPODT.Text.Trim() + "'";
				}
		...
		//					"Where  T051.VEND_CD=T13.VEND_CD and  T06.CONSIGNEE_CD(+)=T13.PURCHASER_CD and  T13.CASE_NO=T17.CASE_NO and T17.CALL_STATUS=T21.CALL_STATUS_CD and "+
		//					"T09.IE_CD =T17.IE_CD  and  T18.CASE_NO=T17.CASE_NO and T18.CALL_RECV_DT=T17.CALL_RECV_DT and T18.CALL_SNO=T17.CALL_SNO and T17.MFG_CD=T052.VEND_CD(+) and "+
		//					"(trim(upper(T13.L5NO_PO))='"+PNO.Trim().ToUpper()+"' and TO_CHAR(T13.PO_DT,'dd/mm/yyyy')='"+PDT+"') and (T17.CALL_RECV_DT between to_date('"+wFrmDt+"','dd/mm/yyyy') and to_date('"+wToDt+"','dd/mm/yyyy'))  and (RLY_NONRLY='R' and RLY_CD IN ('ICF','RB')) OR (T13.RLY_NONRLY='"+CLT+"' and T13.RLY_CD='"+RLYCD+"') and "+ 
		//					"T18.ITEM_SRNO_PO=(Select min(B.ITEM_SRNO_PO) from T18_CALL_DETAILS B where B.CASE_NO=T18.CASE_NO AND B.CALL_RECV_DT=T18.CALL_RECV_DT AND B.CALL_SNO=T18.CALL_SNO) and  "+
		//					"T03.CITY_CD=T051.VEND_CITY_CD and T032.CITY_CD(+)=T052.VEND_CITY_CD and T08.CO_CD(+)=T09.IE_CO_CD ";
		//				
		//			
		...
		//					"Where  T051.VEND_CD=T13.VEND_CD and  T06.CONSIGNEE_CD(+)=T13.PURCHASER_CD and  T13.CASE_NO=T17.CASE_NO and T17.CALL_STATUS=T21.CALL_STATUS_CD and "+
		//					"T09.IE_CD =T17.IE_CD  and  T18.CASE_NO=T17.CASE_NO and T18.CALL_RECV_DT=T17.CALL_RECV_DT and T18.CALL_SNO=T17.CALL_SNO and T17.MFG_CD=T052.VEND_CD(+) and "+
		//					"(T17.CALL_RECV_DT between to_date('"+wFrmDt+"','dd/mm/yyyy') and to_date('"+wToDt+"','dd/mm/yyyy')) and T17.CALL_STATUS='"+lstCallStatus.SelectedValue+"' and ((RLY_NONRLY='R' and RLY_CD IN ('ICF','RB')) OR (T13.RLY_NONRLY='"+CLT+"' and T13.RLY_CD='"+RLYCD+"')) and "+ 
		//					"T18.ITEM_SRNO_PO=(Select min(B.ITEM_SRNO_PO) from T18_CALL_DETAILS B where B.CASE_NO=T18.CASE_NO AND B.CALL_RECV_DT=T18.CALL_RECV_DT AND B.CALL_SNO=T18.CALL_SNO) and  "+
		//					"T03.CITY_CD=T051.VEND_CITY_CD and T032.CITY_CD(+)=T052.VEND_CITY_CD and T08.CO_CD(+)=T09.IE_CO_CD ";
		//			}

...
namespace RBS.Expenditure_Form
{
	public partial class Expenditure_Form : System.Web.UI.Page
	{
		...
		protected void btnSave_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				string Expcheckquery = "Select count(*) from t63_exp where Exp_PER= '" + wYrMth + "' and region_code='" + Session["Region"].ToString() + "'";
				...
				{
					string Expquery = "insert into t63_exp(Exp_PER, region_code, exp_amt, tax_amt, user_id, datetime) " +
						"VALUES('" + wYrMth + "','" + Session["Region"].ToString() + "','" + Convert.ToDecimal(TextExpamt.Text) + "','" + Convert.ToDecimal(Texttaxamt.Text) + "','" + Session["Uname"].ToString() + "',to_date('" + ss + "','dd/mm/yyyy-HH24:MI:SS'))";

...
cellSpacing=1 cellPadding=1 width="100%" border=0>
  ...
  <TR>
    <TD style="HEIGHT: 22px" align=center colSpan=5>
      <P><asp:label id=Label1 runat="server" Font-Names="Verdana" Font-Size="10pt" Font-Bold="True" BackColor="White" ForeColor="DarkBlue" Width="80%">UPDATE SAP DOCUMENT ID IN CREDIT NOTE</asp:label></P></TD></TR>
  <TR>
  ...
  <TR>
    ...
    runat="server" visible="False">
      ...
      >
        <TR>
          <TD style="WIDTH: 10%; HEIGHT: 19px" vAlign=top><asp:label id=Label7 runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True" ForeColor="DarkBlue" Width="100%">Invoice No</asp:label></TD>
          ...
          <TD style="WIDTH: 10%; HEIGHT: 19px" vAlign=top><asp:label id=Label5 runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True" ForeColor="DarkBlue" Width="100%">Bill No</asp:label></TD>
          <TD style="WIDTH: 16%; HEIGHT: 19px" vAlign=top><asp:label id=Label6 runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True" ForeColor="OrangeRed" Width="100%"></asp:label></TD>
...
<asp:label id=Label9 runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True" ForeColor="DarkBlue" Width="105px">Invoice Date Entered in SAP</asp:label>

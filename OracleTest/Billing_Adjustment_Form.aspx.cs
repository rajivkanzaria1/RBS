...
namespace RBS.Billing_Adjustment_Form
{
	public partial class Billing_Adjustment_Form : System.Web.UI.Page
	{
		...
		protected void btnSave_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				string Expcheckquery = "Select count(*) from T85_BILLING_ADJUSTEMENT_PCDO where ADJUSMENT_YR_MTH= '" + wYrMth + "' and region_code='" + Session["Region"].ToString() + "'";
				...
				{
					string Expquery = "insert into T85_BILLING_ADJUSTEMENT_PCDO(REGION_CODE,ADJUSMENT_YR_MTH, ADJUSTMENT_AMT,REMARKS, USER_ID, DATETIME) " +
						"VALUES('" + Session["Region"].ToString() + "', '" + wYrMth + "','" + Convert.ToDecimal(TextExpamt.Text) + "','" + txtRemarks.Text + "','" + Session["Uname"].ToString() + "',to_date('" + ss + "','dd/mm/yyyy-HH24:MI:SS'))";

...
namespace RBS.checksheet {
    ...
    public class rptLowmentance : ReportClass {
        
        public rptLowmentance() {
        }
        
        public override string ResourceName {
            get {
                return "rptLowmentance.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "RBS.checksheet.rptLowmentance.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptLowmentance : Component, ICachedReport {
        
        public CachedrptLowmentance() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptLowmentance rpt = new rptLowmentance();
            rpt.Site = this.Site;
            return rpt;
        }

...
{
	public partial class Lab_Billing_Form : System.Web.UI.Page
	{
		...
		protected void btnSave_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				string Labcheckquery = "Select count(*) from t59_lab_exp where lab_bill_per= '" + wYrMth + "' and region_code='" + Session["Region"].ToString() + "'";
				...
				{
					string Labquery = "insert into t59_lab_exp(lab_bill_per, region_code, lab_exp, user_id, datetime) " +
						"VALUES('" + wYrMth + "','" + Session["Region"].ToString() + "','" + Convert.ToDecimal(Textamt.Text) + "','" + Session["Uname"].ToString() + "',to_date('" + ss + "','dd/mm/yyyy-HH24:MI:SS'))";

...
namespace RBS.Cr_rejection
{
	public partial class Cr_rejection : System.Web.UI.Page
	{
		...
		protected void btnSave_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				string Expquery = "insert into T81_CR_REJ(REJ_DT, CASE_NO, CONSIGNEE, DES_COM, CONCLUSION, REGION, USER_ID, DATETIME) " +
					"VALUES('" + wYrMth + "','" + Texcaseno.Text + "','" + Textcon.Text + "','" + Textdes.Text + "','" + Textaction.Text + "','" + Session["Region"].ToString() + "','" + Session["Uname"].ToString() + "',to_date('" + ss + "','dd/mm/yyyy-HH24:MI:SS'))";

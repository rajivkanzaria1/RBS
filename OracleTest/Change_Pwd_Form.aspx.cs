...
namespace RBS.Change_Pwd_Form
{
	public partial class Change_Pwd_Form : System.Web.UI.Page
	{
		...
		protected void btnSubmit_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				string str3 = "select PASSWORD from T02_USERS where (USER_ID='" + txtUID.Text + "' and PASSWORD='" + txtOPwd.Text + "')";
				...
				{
					string myUpdateQuery = "Update T02_USERS set PASSWORD ='" + txtNPwd.Text + "' where USER_ID='" + txtUID.Text + "'";

...
namespace RBS.Vendor {
    ...
    public class NR_Bill_GST : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "RBS.Vendor.NR_Bill_GST.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedNR_Bill_GST : Component, ICachedReport {
        
        public CachedNR_Bill_GST() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            NR_Bill_GST rpt = new NR_Bill_GST();
            rpt.Site = this.Site;
            return rpt;
        }

...
{
	public partial class UpdateBillsFromExcel_Lab : System.Web.UI.Page
	{
		...
		public DataTable GetDataFromExcel()
		{
			...
			try
			{
				...
				OleDbConnection oledbconn = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Server.MapPath("~/QR_UPDATE6.xls").ToString() + ";Extended Properties=Excel 8.0;");
		...
		protected void Button1_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				foreach (DataRow dr in dt.Rows)
				{
					...
					//myInsertCommandM.CommandText="update T22_BILL set ACK_NO='" + dr["ACK_NO"].ToString() + "', ACK_DT=TO_DATE('" + dr["ACK_DT"].ToString()+ "','DD/MM/YYYY-HH24:MI:SS') , IRN_NO='" + dr["IRN_NO"].ToString() + "', QR_CODE='" + dr["QR_CODE"].ToString() + "' where CREDIT_DOC_ID='" + dr["CREDIT_DOC_ID"].ToString() + "'";

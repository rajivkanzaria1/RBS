...
namespace RBS
{
    public partial class PurchesOrder_Form11 : System.Web.UI.Page
    {
		...
		public void search()
		{
			try
			{
				...
				string str1 = "select CASE_NO,PURCHASER_CD,STOCK_NONSTOCK,RLY_NONRLY,PO_OR_LETTER,PO_NO,L5NO_PO,to_char(PO_DT,'dd/mm/yyyy')PO_DT,to_char(RECV_DT,'dd/mm/yyyy')RECV_DT,VEND_CD,RLY_CD,REGION_CODE,REMARKS,INSPECTING_AGENCY,POI_CD from T13_PO_MASTER where CASE_NO='" + lblCasNo.Text + "'";
		...
		protected void btnPODetails_Click(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("PurchesOrderDetails.aspx?CASE_NO=" + caseno + "&type=" + pt + "&PODT=" + txtPOdate.Text.Trim() + "&PO_OR_LOA=" + ddlPOLetter.SelectedValue);
		}
		// ------------------ Clearing Fields ------------------ //
		public void clear()
		{
		...
		protected void btnSaveCB_Click(object sender, System.EventArgs e)
		{
			try
			{
		...
		protected void btnDelCB_Click(object sender, System.EventArgs e)
		{
			try
			{
				string cno = lblCasNo.Text;
			...
			try
			{
				if (File1.PostedFile != null && File1.PostedFile.ContentLength > 0)
				{
					...
					if (fx == ".PDF")
					{
						...
						SaveLocation = Server.MapPath("CASE_NO/" + lblCasNo.Text + ".pdf");

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login_Form.aspx.cs" Inherits="RBS.Login_Form.Login_Form" %>
												...
												<TBODY>
													<TR height="35%">
														<TD style="FONT-WEIGHT: bold; FONT-SIZE: 10pt; WIDTH: 70px; COLOR: navy; FONT-FAMILY: Verdana; HEIGHT: 35px">User 
															Id:</TD>
														<TD style="HEIGHT: 35px"><asp:textbox id="txtUname" tabIndex="1" runat="server" Width="75%" Height="25px" ForeColor="DarkBlue"

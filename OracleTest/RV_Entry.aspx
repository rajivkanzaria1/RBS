<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RV_Entry.aspx.cs" Inherits="RBS.RV_Entry.RV_Entry" %>
	...
	<BODY bgColor="white" onload="sFocus();">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
					<TD style="HEIGHT: 28px" align="center" colSpan="5">
						<P><asp:label id="Label1" runat="server" Font-Names="Verdana" Font-Size="10pt" Font-Bold="True"
								BackColor="White" ForeColor="DarkBlue" Width="196px">RECIEPT VOUCHER</asp:label></P>
					</TD>
				</TR>
				<TR>
					<TD style="HEIGHT: 26px" align="left">
						<TABLE id="Table3" style="WIDTH: 100%; HEIGHT: 32px" borderColor="#b0c4de" cellSpacing="1"
							...
							<TR>
								<TD style="WIDTH: 15%" vAlign="top"><asp:label id="Label2" runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True"
										ForeColor="DarkBlue" Width="100%"> Voucher No.</asp:label></TD>
								<TD style="WIDTH: 17.68%" vAlign="top"><asp:textbox id="txtVNO" tabIndex="1" runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue"
										Width="90%" MaxLength="8" Height="20px"></asp:textbox><asp:label id="lblVNo" runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True"
										ForeColor="OrangeRed" Width="60%"></asp:label></TD>
								<TD style="WIDTH: 15%; HEIGHT: 9px" vAlign="top" align="left"><asp:button id="btnSearch" tabIndex="14" runat="server" Font-Names="Verdana" Font-Size="8pt"
										Font-Bold="True" ForeColor="DarkBlue" Width="111px" Text="Edit Voucher" onclick="btnSearch_Click"></asp:button><asp:label id="Label6" runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True"
										ForeColor="DarkBlue" Width="100%">Voucher Date.</asp:label></TD>
								<TD style="WIDTH: 15.88%; HEIGHT: 9px" vAlign="top">
									<P><asp:label id="lblVDT" runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True"
											ForeColor="OrangeRed" Width="100%"></asp:label><asp:textbox id="txtVDT" onblur="check_date(txtVDT);" tabIndex="2" runat="server" Font-Names="Verdana"
											Font-Size="8pt" ForeColor="DarkBlue" Width="90%" MaxLength="11" Height="20px"></asp:textbox></P>
								</TD>
								<TD style="WIDTH: 5.76%; HEIGHT: 9px" vAlign="top"><asp:label id="Label10" runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True"
										ForeColor="DarkBlue" Width="100%"> Bank/Cash</asp:label></TD>
								<TD style="WIDTH: 40%; HEIGHT: 9px" vAlign="top">
									<P><asp:label id="lblBank" runat="server" Font-Names="Verdana" Font-Size="8pt" Font-Bold="True"
											ForeColor="OrangeRed" Width="100%"></asp:label><asp:dropdownlist id="lstBank" tabIndex="3" runat="server" Font-Names="Verdana" Font-Size="8pt" ForeColor="DarkBlue"
											Width="100%" AutoPostBack="True" onselectedindexchanged="lstBank_SelectedIndexChanged"></asp:dropdownlist></P>
								</TD>
							</TR>
						</TABLE>
					</TD>
				...
				<TR>
					<TD><asp:panel id="Panel" runat="server" Height="198px" HorizontalAlign="Center">
							<TABLE id="Table5" style="WIDTH: 100%; POSITION: relative; TOP: 0px; HEIGHT: 168px" borderColor="#b0c4de"
								...
								<TR>
									...
									<TD style="WIDTH: 31.11%; HEIGHT: 24px" align="center">
										...
										<asp:label id="lblCash" runat="server" Width="40%" ForeColor="OrangeRed" Font-Bold="True" Font-Size="8pt"
											Font-Names="Verdana">CASH</asp:label></TD>
									...
									<TD style="WIDTH: 20%; HEIGHT: 24px" align="center">
										<asp:textbox id="txtSNo" style="TEXT-ALIGN: center" tabIndex="8" runat="server" Width="60%" ForeColor="DarkBlue"
											Font-Size="8pt" Font-Names="Verdana" Height="20px" MaxLength="4"></asp:textbox></TD>
								</TR>
								<TR>
								...
								<TR>
									<TD style="WIDTH: 594px" align="center" colSpan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<asp:button id="btnDel2" tabIndex="17" runat="server" Width="67px" ForeColor="DarkBlue" Font-Bold="True"
											Font-Size="8pt" Font-Names="Verdana" Text="Delete" Visible="False" onclick="btnDel2_Click"></asp:button>
						...
						<DIV><TITTLE:CUSTOMDATAGRID id="grdVDt" runat="server" Width="100%" Height="8px" BorderColor="DarkBlue" AutoGenerateColumns="False"
								...
								BorderWidth="1px" FreezeColumns="0" FreezeHeader="True" GridHeight="250px" GridWidth="100%">
								...
								<Columns>
									<asp:TemplateColumn HeaderText="SNo.">
										...
										<ItemTemplate>
											<asp:HyperLink id=HyperLink1 runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"SNO")%>' NavigateUrl='<%#"RV_Entry.aspx?VOUCHER_NO=" + DataBinder.Eval(Container.DataItem,"VCHR_NO") + "&amp;ACTION=M" + "&amp;VOUCHER_TYPE="+VTYPE+ "&amp;SNO=" + DataBinder.Eval(Container.Dataitem,"SNO")%>'>HyperLink</asp:HyperLink>
										</ItemTemplate>
									</asp:TemplateColumn>

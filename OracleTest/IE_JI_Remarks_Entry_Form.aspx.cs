...
{
	public partial class IE_JI_Remarks_Entry_Form : System.Web.UI.Page
	{
		string wIECD;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!(IsPostBack))
			{
				...
				string sql = "Select to_char(COMPLAINT_DT,'dd/mm/yyyy')COMPLAINT_DATE,REJ_MEMO_NO,to_char(REJ_MEMO_DT,'dd/mm/yyyy')REJ_MEMO_DATE,CASE_NO,BK_NO,SET_NO," +
					...
					"REJECTION_REASON From V40_CONSIGNEE_COMPLAINTS Where COMPLAINT_ID='" + lblComplID.Text + "'";
		...
		{
			Response.Redirect("IE_JI_Remarks_Pending_Form.aspx");
		}
		...
		protected void btnSave_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				string updateQuery = "Update T40_CONSIGNEE_COMPLAINTS set IE_JI_REMARKS='" + txtRemarks.Text.Trim() + "',IE_JI_REMARKS_DT=to_date('" + txtSTDT.Text + "','dd/mm/yyyy') where COMPLAINT_ID='" + lblComplID.Text.Trim() + "' ";
		...
		void send_IE_Email()
		{
			...
			try
			{
				...
				{
					cc = "wrinspn@rites.com;mmurali@rites.com";
				}
				else if (lblCSNO.Text.Substring(0, 1) == "E")
				{
				...
				else
				{
					if (Session["Region"].ToString() == "N")
					{
						cc = cc + ";nrinspn@rites.com;ramendrakumar@rites.com";
					}
					else if (Session["Region"].ToString() == "S")
					{
					...
					{
						cc = cc + ";wrinspn@rites.com;mmurali@rites.com";
					}
					else if (Session["Region"].ToString() == "E")
					{
